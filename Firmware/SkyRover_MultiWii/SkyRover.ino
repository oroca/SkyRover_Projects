...
March  2013     V2.2
 ...
 any later version. see <http://www.gnu.org/licenses/>
  ...
  <SkyRover Project>
    - HexAirBot 기반의 쿼드콥더 프로젝트로 기존의 AVR기반을 STM32계열로 포팅함 
...
void setup() {
  ...
  Serial1.println("start 1");
  Serial1.println("start K");
